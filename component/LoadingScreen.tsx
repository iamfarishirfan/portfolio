...
interface Data {
    ...
    toLoad: SetStateAction<number>;
    loaded: SetStateAction<number>;
    sourceName: string;
}
...
export default function LoadingScreen() {
    ...
    useEffect(() => {
        ...
        // @ts-ignore
        EventBus.on('loadedSource', (data: Data) => {
                ...
                >
                    ...
                    >
                        ...
                        <div style={styles.headerInfo}>
                            <p>Released: {dateString}</p>
                            <p>FIBIOS (C) 2007 FBIOS Inc.</p>
                        </div>
                    </div>
                    <div style={styles.body} className="loading-screen-body">
                        <p>HSP S13 2007-{year} Special UC131S</p>
                        ...
                        {showLoadingResources && doneLoading && (
                            <p>
                                ...
                                <b style={styles.green}>Test</b> V1.0
                            </p>
                        )}
                        <div style={styles.spacer} />
                        <span className="blinking-cursor" />
            ...
            {firefoxError && (
                ...
                >
                    <div style={styles.startPopup}>
                        ...
                        <div style={styles.spacer} />
                        <p>
                            Due to a bug in Firefox, this website is temporarily
                            inaccessible for anyone using the browser.
                        </p>
                        <div style={styles.spacer} />
                        <p>
                            I apologize for the inaccessibility. As this site is
                            now public I will try and to find a work around.
                            Whether or not that will fix the bug is unknown.
